...
- [ ] Build iPhone di questa revisione BLOCCATA: Xcode non trova il profilo dello stesso identificativo. Tentativo di recupero automatico fallito con “No Accounts” e credenziali Xcode mancanti nel portachiavi. Serve ripristinare l'accesso Apple Developer in Xcode → Settings → Accounts; non cambiare team o bundle ID. Il pacchetto iPhone ancora presente in build/DerivedDataDevice è quello del 10 settembre `9ae58118c3f7`, NON contiene i nuovi gruppi MIX.
